# Parte do código feito com a ajuda do Guilherme Luis e Gabriel Coruja
...
class TrackOrders:
    ...
    def get_order_frequency_per_costumer(self, costumer, order):
        ...
        return f"""Quantidade de pedidos de {order} feito pelo/a cliente
         {costumer}: {frequency[order]}"""
    ...
    def get_never_ordered_per_costumer(self, costumer):
        ...
        return f"""Pedido nunca pedido pelo(a) cliente {self._data[0][0]}:
         {products.difference(frequency)}"""
    ...
    def get_days_most_visited_per_costumer(self, costumer):
        ...
        return f"""Dia(s) mais visitado(s) pelo(a) cliente {costumer}:
         {days_set.intersection(present_days_set)}"""
    ...
    def get_days_never_visited_per_costumer(self, costumer):
        ...
        return f"""Dia(s) menos visitado(s) pelo(a) cliente
         {self._data[0][0]}: {days_set.difference(present_days_set)}"""
